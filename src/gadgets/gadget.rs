...
use halo2_proofs::{
  ...
  plonk::{Advice, Column, Error, Fixed, Selector, TableColumn, CqColumn},
};
...
pub struct GadgetConfig {
  ...
  pub cq_columns: Vec<Column<Advice>>,
