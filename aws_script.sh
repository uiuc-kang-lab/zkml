...
./target/release/time_circuit testing/data/gpt2/model_0.msgpack testing/data/gp2/example_inp.msgpack ipa > debug_gpt2_ipa.txt
./target/release/time_circuit testing/data/gpt2/model_0.msgpack testing/data/gp2/example_inp.msgpack kzg > debug_gpt2_kzg.txt
