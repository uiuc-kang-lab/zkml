...
./target/release/time_circuit data/gpt2/model_40.msgpack data/gpt2/example_inp.msgpack ipa > data/gpt2/model_40_ipa.txt
rm pkey
...
# gpt best: | k=24 | c=25 | i=0
./target/release/time_circuit data/gpt2/model_best.msgpack data/gpt2/example_inp.msgpack kzg > data/gpt2/model_best_kzg.txt
rm pkey
# gpt 40: | k=24 | c=40 | i=0
./target/release/time_circuit data/gpt2/model_40.msgpack data/gpt2/example_inp.msgpack kzg > data/gpt2/model_40_kzg.txt
rm pkey
